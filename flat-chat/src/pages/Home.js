...
const Home = () => {
  ...
  if(Object.keys(user).length == 0){
    ...
    return <div className="relative h-screen">
        ...
        <div className='bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-700 opacity-75  h-14 absolute top-2 mx-0.5 md:mx-2 flex justify-between' style = {{zIndex:1000, width: "98%", fontFamily: "Climate Crisis"}}>
        </div>
        <div className='h-14 absolute top-2 flex justify-between' style = {{zIndex:1000, width: "98%", fontFamily: "Climate Crisis"}}>
        <div className='text-white text-opacity-100 text-2xl m-3 md:mx-8'>Find Flat</div>
